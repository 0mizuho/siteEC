...
public class InputChecker {
	...
	public List<String> doCheck(String propertyName,String value,int minLength,int maxLength,boolean availableAlphabeticCharacters,
			boolean availableKanji,boolean availableHiragana,boolean availableHalfWidthDigit,boolean availableHalfWidthSymbols,
			boolean availableKatakana,boolean availableFullWidthSymbols){
	//検証した結果を入れるList//
...
/*errorとregularの処理の違いはなに？*/
		...
		//isEmptyは「その入れ物は空か」聞くメソッド。入れ物自体が「ない」nullと前提が違う。//
		//String.isEmptyは空文字のみ判定の為、空文字とnull判定ができるStringUtils.isEmptyだと対応の幅が広がる//
	...
	//一度目のパスワードと二度目のパスワードが同じかを検証するメソッド//
